...
def get_training_data(video_path,
	...
	assert dataset_name in['kinetics','ucf101','hmdb51','kinetics_lau']
	...
	video_path_formatter = (lambda root_path,label,video_id:root_path /'train'/label / video_id)
...
def get_validation_data(video_path,
                        ...
                        temporal_transform=None,
                        target_transform=None):
	assert dataset_name in ['kinetics', 'activitynet', 'ucf101', 'hmdb51', 'mit','kinetics_lau']
	assert input_type in ['rgb', 'flow']
	assert file_type in ['jpg', 'hdf5']
	...
	video_path_formatter = (
		lambda root_path, label, video_id: root_path /'val'/label / video_id)
...
def get_inference_data(video_path,
	...
	assert dataset_name in [
		'kinetics', 'activitynet', 'ucf101', 'hmdb51', 'mit','kinetics_lau'
	]
	assert input_type in ['rgb', 'flow']
	assert file_type in ['jpg', 'hdf5']
