...
if __name__ == '__main__':
	...
	parser.add_argument('--dst_path',
	                    default='/home/lzhao/FILE/datasets/kinetics/subset/test_kinetics.json',
	                    type=Path,
	                    help='Path of dst json file.')
	args = parser.parse_args()

	train_csv_path = (args.dir_path / 'test_train_subset.csv')
	val_csv_path = (args.dir_path / 'test_val_subset.csv')
	test_csv_path = None
